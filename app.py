...
# =========================================================
# CONEXAO COM BANCO DE DADOS - SUPABASE / STREAMLIT CLOUD
# =========================================================

def obter_secret(chave, padrao=None):
    """Lê primeiro variável de ambiente e depois Streamlit Secrets."""
    ...
    try:
        ...
        if not all([host, porta, banco, usuario, senha]):
            st.error(
                ...
                "Configure DB_HOST, DB_PORT, DB_NAME, DB_USER e DB_PASSWORD "
                "em Streamlit Cloud → App settings → Secrets."
            )
            return None
